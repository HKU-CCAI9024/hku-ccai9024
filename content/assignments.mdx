...
- Music Description File (PDF Format):
 - Content Part 1 (Music Description): Briefly describe the music's style, mood, and primary instruments, and explain how it enhances the atmosphere of your story.
 - Content Part 2 (Appendix: GenAI Tool & Prompt Summary): List all music generation tools used in 'Tool List' (Format: Tool Name | Version/Type | Usage Purpose; Example: Suno AI | V3 | Generate background music). For each new tool, list 3-5 key prompts.
 - Filename: description.pdf.
