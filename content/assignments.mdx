...
**Release: September 20, 2025   Due: September 27, 2025**
...
- Appendix: LLM Tool & Prompt Summary (Place this section after the story). List all LLMs used in 'Tool List' (Format: Tool Name | Version/Type | Usage Purpose; Example: ChatGPT | 4.0 | Generate text). For each tool, list 3–5 key prompts in 'Prompt Summary'. 
...
- Appendix: LLM Tool & Prompt Summary (Place this section after the Website Introduce). List all LLMs used in 'Tool List' (Format: Tool Name | Version/Type | Usage Purpose; Example: ChatGPT | 4.0 | Generate text). For each tool, list 3–5 key prompts in 'Prompt Summary'. 
...
- Appendix: LLM Tool & Prompt Summary (Place this section after the Website Refinement Changes Introduce). List all LLMs used in 'Tool List' (Format: Tool Name | Version/Type | Usage Purpose; Example: ChatGPT | 4.0 | Generate text). For each tool, list 3–5 key prompts in 'Prompt Summary'. 
...
####Content Part 2 (Appendix: GenAI Tool & Prompt Summary): List all image generation used in 'Tool List' (Format: Tool Name | Version/Type | Usage Purpose; Example: Midjourney | V5.2 | Generate logo concepts). For each tool, list 3-5 of the most critical or representative final prompts that led to your final design.
...
- Video File (created for your story) in MP4 format with the length of l5-30 seconds. Minimum of 720p (1280x720). Filename: teaser.mp4. File Size Limit: 50MB. If your file exceeds this limit, please upload it to YouTube or Google Drive and provide a publicly accessible link in the description PDF.
...
####Content Part 2 (Appendix: GenAI Tool & Prompt Summary): List all video generation and editing tools used in 'Tool List' (Format: Tool Name | Version/Type | Usage Purpose; Example: Runway | Gen-2 | Generate video clips from text). For each tool, list 3-5 key prompts or operational commands.
####Filename: description.pdf.
---
